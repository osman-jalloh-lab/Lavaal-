...
const base = { sourceProductId: '1', category: 'phones', brand: 'Samsung', family: 'Galaxy S', name: 'Galaxy S', mpn: 'SM-1', gtin: '1', source: 'open-icecat', identityStatus: 'verified', mediaUsageStatus: 'permitted', primaryImage: 'images/1.webp', images: [{ path: 'images/1.webp' }], specifications: [{ name: 'Internal storage capacity', value: '128', unit: 'GB' }] };
